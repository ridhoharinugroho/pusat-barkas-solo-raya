...
CREATE TABLE IF NOT EXISTS public.users (
  ...
  region        TEXT,
  district      TEXT,
  password      TEXT,   -- NOTE: di produksi gunakan hash (bcrypt), bukan plaintext
  avatar        TEXT,
  bio           TEXT,
...
-- ============================================================
-- 6. FUNCTION: increment_listing_views (atomic counter)
-- ============================================================
...
-- ============================================================
-- 7. Enable Realtime untuk semua tabel
-- ============================================================
