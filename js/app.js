  ...
  if (!user) {
    ...
    container.innerHTML = `
      <div class="relative flex-shrink-0">
        <button id="btn-header-user-menu" class="flex items-center gap-1 sm:gap-2 p-1 pr-1.5 sm:pr-2.5 bg-slate-100 hover:bg-slate-200 rounded-full border border-slate-200 transition-colors cursor-pointer">
        ...
        <div id="header-user-dropdown-menu" class="hidden absolute right-0 top-full pt-1.5 w-56 sm:w-60 z-50">
          <div class="bg-white rounded-2xl shadow-2xl border border-slate-200 py-2 text-xs text-slate-700">
            ...
            <button id="menu-btn-logout" class="w-full text-left px-3.5 py-2 text-rose-600 hover:bg-rose-50 flex items-center gap-2 font-bold cursor-pointer">
