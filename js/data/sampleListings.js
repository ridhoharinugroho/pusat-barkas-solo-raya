...
export const SAMPLE_LISTINGS = [
  {
    id: "barkas-001",
    title: "Sepeda Lipat Polygon Urbano 3 Mulus Terawat Bonus Helm",
    price: 1850000,
    category: "hobi",
    condition: "good",
    negoType: "nego_alus",
    regionId: "solo",
    district: "Banjarsari",
    codPoint: "COD Area Manahan / Lapangan Kota Barat Solo",
    description: "Dijual santai sepeda lipat Polygon Urbano 3 warna hitam doff. Kondisi 90% mulus, rem pakem, gear shifting 7-speed Shimano lancar jaya tanpa kendala. Jarang dipakai cuma buat CFD Slamet Riyadi. Bonus helm sepeda & bel lonceng. Monggo dicek sepuasnya sambil ngopi di Manahan.",
    images: [
  ...
  {
    id: "barkas-004",
    title: "Gitar Akustik Yamaha F310 Original Free Softcase Kulit",
    price: 750000,
    category: "hobi",
    condition: "like_new",
    negoType: "nego_tipis",
  ...
  },
  {
    ...
    seller: {
      id: "user-105",
      displayName: "Cak Lutfi Delanggu",
      phone: "082136789012",
      email: "lutfi.klt@gmail.com",
  ...
  {
    id: "barkas-007",
    title: "Smart TV LG 32 Inch Digital DVB-T2 Gambar Jernih Lengkap Remote",
    price: 1350000,
    category: "elektronik",
    condition: "like_new",
    negoType: "nego_tipis",
  ...
  {
    id: "barkas-008",
    title: "Sofa Minimalis L-Shape Ruang Tamu Busa Masih Tebal",
    price: 1100000,
    category: "perabot",
    condition: "good",
    negoType: "nego_alus",
  ...
  {
    id: "barkas-009",
    title: "Kamera Mirrorless Sony A6000 + Lensa Kit 16-50mm Normal Siap Hunting",
    price: 4300000,
    category: "elektronik",
    condition: "good",
    negoType: "nego_alus",
  ...
  {
    id: "barkas-010",
    title: "Helm KYT TT Course Dalla Porta Fullset Visor Iridium Blue",
    price: 950000,
    category: "kendaraan",
    condition: "like_new",
    negoType: "pas",
  ...
  {
    id: "barkas-011",
    title: "Jaket Kulit Asli Vintage Garut Size XL Tebal & Gagah",
    price: 380000,
    category: "pakaian",
    condition: "good",
    negoType: "nego_alus",
  ...
  {
    id: "barkas-012",
    title: "Kulkas Polytron Belleza 1 Pintu Normal Dingin Beku Cepat",
    price: 780000,
    category: "perabot",
    condition: "good",
    negoType: "nego_tipis",
  ...
  {
    id: "barkas-015",
    title: "Rumah Paviliun Minimalis Dekat Kampus UNS Kentingan Solo",
    price: 185000000,
    category: "properti",
    condition: "good",
    negoType: "nego_alus",
    regionId: "solo",
    district: "Jebres",
    codPoint: "Survei Lokasi Langsung Dekat Kampus UNS Kentingan Solo",
    description: "Dijual paviliun/rumah minimalis siap huni di Jebres Solo, sangat dekat kampus UNS & ISI. Luas tanah 60m2, 2 kamar tidur, 1 kamar mandi, dapur, carport motor/mobil kecil, air sumur lancar, SHM siap balik nama.",
    images: [
  ...
  {
    id: "barkas-016",
    title: "Jasa Cuci & Servis AC Panggilan Area Solo Raya Bergaransi",
    price: 65000,
    category: "jasa",
    condition: "like_new",
    negoType: "pas",
    regionId: "solo",
    district: "Banjarsari",
    codPoint: "Panggilan Langsung ke Rumah / Kantor se-Solo Raya",
    description: "Melayani jasa cuci AC, tambah freon, bongkar pasang AC, dan perbaikan AC mati/kurang dingin untuk area Solo, Sukoharjo, Karanganyar, dan sekitarnya. Teknisi berpengalaman, ramah, dan bergaransi 30 hari.",
    images: [
